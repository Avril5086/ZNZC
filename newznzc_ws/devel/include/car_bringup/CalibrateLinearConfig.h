...
#ifndef __car_bringup__CALIBRATELINEARCONFIG_H__
#define __car_bringup__CALIBRATELINEARCONFIG_H__
...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(CalibrateLinearConfig::AbstractParamDescriptionConstPtr(new CalibrateLinearConfig::ParamDescription<int>("direction", "int", 0, "A size parameter which is edited via an enum", "{'enum_description': 'An enum to set size', 'enum': [{'srcline': 9, 'description': 'first data', 'srcfile': '/home/mowen/newznzc_ws/src/car_bringup/cfg/CalibrateLinear.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Y'}, {'srcline': 9, 'description': 'two data', 'srcfile': '/home/mowen/newznzc_ws/src/car_bringup/cfg/CalibrateLinear.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'X'}]}", &CalibrateLinearConfig::direction)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 9 "/home/mowen/newznzc_ws/src/car_bringup/cfg/CalibrateLinear.cfg"

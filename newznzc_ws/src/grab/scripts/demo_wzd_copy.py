...
def start():  #前往起始点
    ...
    goal.goal.target_pose.pose.position.x= 0.129083960605
    goal.goal.target_pose.pose.position.y= 0.0889484167335
    goal.goal.target_pose.pose.orientation.z = 0.00985849647433
    goal.goal.target_pose.pose.orientation.w = 0.999951403843
...
def middle():  #前往中间点
    ...
    goal.goal.target_pose.pose.position.x= 3.06310224533
    goal.goal.target_pose.pose.position.y=  0.1158407107
    goal.goal.target_pose.pose.orientation.z =0.00800698262756
    goal.goal.target_pose.pose.orientation.w =  0.999967943601
...
def sort0():  #前往1号点
    ...
    goal.goal.target_pose.pose.position.x= 3.0616774559
    goal.goal.target_pose.pose.position.y= 0.532800614834
    goal.goal.target_pose.pose.orientation.z =0.71308212971
    goal.goal.target_pose.pose.orientation.w =0.701080506282
    Npub.publish(goal)
...
def sort1():  #前往2号点
    ...
    goal.goal.target_pose.header.frame_id="map"
    goal.goal.target_pose.pose.position.x= 2.72777032852
    goal.goal.target_pose.pose.position.y= 0.587559401989
    goal.goal.target_pose.pose.orientation.z = 0.999802282923
    goal.goal.target_pose.pose.orientation.w = -0.0198845433168
    Npub.publish(goal)
def sort2():  #前往3号点
    goal=MoveBaseActionGoal()

    goal.goal.target_pose.header.frame_id="map"
    goal.goal.target_pose.pose.position.x=  2.52311968803
    goal.goal.target_pose.pose.position.y=  0.62380194664
    goal.goal.target_pose.pose.orientation.z = -0.0248030001519
    goal.goal.target_pose.pose.orientation.w = 0.99969235827
    Npub.publish(goal)
# def sort3():  #前往4号点
#     goal=MoveBaseActionGoal()
